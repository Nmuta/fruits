...
class FruitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fruit" do
    assert_difference('Fruit.count') do
      post fruits_url, params: { fruit: { category_id: @fruit.category_id, name: @fruit.name, price: @fruit.price, source: @fruit.source, url: @fruit.url } }
    end
  ...
  test "should update fruit" do
    patch fruit_url(@fruit), params: { fruit: { category_id: @fruit.category_id, name: @fruit.name, price: @fruit.price, source: @fruit.source, url: @fruit.url } }
